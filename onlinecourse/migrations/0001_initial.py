    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choice_text', models.CharField(default='Test', max_length=500)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notes', models.CharField(default='aman', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_text', models.CharField(default='pertanyaan', max_length=1000)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='onlinecourse.course')),
            ],
        ),
        migrations.CreateModel(
